...
module.exports = (client, oldMember, newMember) => {
  ...
  if (oldMember.nickname != newMember.nickname) {
    ...
    if (
      ...
      nicknameLog.permissionsFor(oldMember.guild.members.me).has([PermissionFlagsBits.SendMessages, PermissionFlagsBits.EmbedLinks])
    ) {
  ...
  if (oldMember.roles.cache.size < newMember.roles.cache.size) {
    ...
    if (
      roleLog &&
      roleLog.viewable &&
      roleLog.permissionsFor(oldMember.guild.members.me).has([PermissionFlagsBits.SendMessages, PermissionFlagsBits.EmbedLinks])
    ) {
